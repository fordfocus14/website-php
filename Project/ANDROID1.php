          ...
          <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/AD1.jpg" class="d-block w-100" >
              </div>
              <div class="carousel-item">
                <img  src="images/AD2.jpg" class="d-block w-100">
              </div>
          ...
          <div class=" row">
            ...
            <form action="createcart.php" method="post">
              <div class="product-top">
               <img name="image" src="images/AD3.jpg">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>Sumsung</h3>
                <h5>$1000</h5>
                <input type="hidden" name="Item_Name" value="Sumsung">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <i class="fa fa-star"></i>
                <i class="fa fa-star-half-o"></i>
                <h3>Sumsung Galaxy S6</h3>
                <h5>$1600.00</h5>
                <input type="hidden" name="Item_Name" value="Sumsung Galaxy S6">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>Tecno Y4</h3>
                <h5>$470.00</h5>
                <input type="hidden" name="Item_Name" value="Tecno Y4">
