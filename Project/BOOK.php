          ...
          <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/bk6.jpg" class="d-block w-100" >
              </div>
              <div class="carousel-item">
                <img  src="images/bk5.jpg" class="d-block w-100">
              </div>
          ...
          <div class=" row">
            ...
            <form action="createcart.php" method="post">
              <div class="product-top">
               <img name="image" src="images/bk1.jpg">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>Tutorials</h3>
                <h5>$19.00</h5>
                <input type="hidden" name="Item_Name" value="Tutorials">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>AI</h3>
                <h5>$17.00</h5>
                <input type="hidden" name="Item_Name" value="AI">
