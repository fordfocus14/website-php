          ...
          <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/LP6.jpg" class="d-block w-100" >
              </div>
              <div class="carousel-item">
                <img  src="images/LP5.jpg" class="d-block w-100">
              </div>
          ...
          <div class=" row">
            ...
            <form action="createcart.php" method="post">
              <div class="product-top">
               <img name="image" src="images/LP4.jpg">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>HP-i7</h3>
                <h5>$1000</h5>
                <input type="hidden" name="Item_Name" value="HP-i7">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>Dell i5</h3>
                <h5>$400.00</h5>
                <input type="hidden" name="Item_Name" value="Dell i5">
