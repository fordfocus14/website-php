          ...
          <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/ds5.jpg" class="d-block w-100" >
              </div>
              <div class="carousel-item">
                <img  src="images/ds6.jpg" class="d-block w-100">
              </div>
          ...
          <div class=" row">
            ...
            <form action="createcart.php" method="post">
              <div class="product-top">
               <img name="image" src="images/ds2.jpg">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <h3>Simple Top</h3>
                <h5>$19.00</h5>
                <input type="hidden" name="Item_Name" value="Simple Top">
            ...
            <form action="createcart.php" method="post">
              ...
              <div class="product-bottom text-center">
                ...
                <i class="fa fa-star"></i>
                <i class="fa fa-star-half-o"></i>
                <h3>Straight Dress</h3>
                <h5>$17.00</h5>
                <input type="hidden" name="Item_Name" value="Straight Dress">
